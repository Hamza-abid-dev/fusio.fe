      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col mt-3">
            ...
            <h5 className="bg-[#05E700] p-1 text-xs text-[green] font-bold w-[40%] mt-1 rounded-sm">Approved</h5>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-4">
          <button className="bg-[#00B2FF] py-1 px-2 rounded-md shadow-lg shadow-black/20">View Transaction</button>
